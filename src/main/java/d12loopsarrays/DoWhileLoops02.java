        ...
        do {
            ...
            if (userName.equals("admin") && password.equals("pwd123")) {
                ...
                if (counter == maxTries) {
                    ...
                    System.out.println("kalan deneme hakkiniz : " + maxTries);
                    int remaningTries=maxTries-counter;
                    System.out.println("yanlis kullanici veya parola girisi "+ remaningTries+ " hakkin kaldi");
                }
