...
public class Lambda01 {
    public static void main(String[] args) {
        ...
        //printElements1(nums);
        //printElements2(nums);
        //printEventElements1(nums);
        printEventElements2(nums);
    ...
    public static void printElements2(List<Integer> nums) {
        ...
        nums.stream().forEach(t -> System.out.print(t + " ")); //t degisken adidir (type'dan gelir).//Akıştan gelen her t için, o t'lerin herbirini yazdir. //12 9 131 14 9 10 4 12 15
        //nums`in akisindan gelen her t icin t`yi yazdir (icin ->)
    ...
    // numbers to the console on the same line, with a space between them.(Structure
