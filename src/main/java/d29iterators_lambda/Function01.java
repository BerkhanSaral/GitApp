...
public class Function01 {
    public static void main(String[] args) {
        ...
        Function<T, R>: apply(), girdi ve çıktı arasında bir dönüşüm veya işlem gerektiriyorsa kullanilir. Tek bir girdi alır ve tek bir çıktı üretir
        ...
        //Arastirma odevi 1):: java da baska fonksiyonel arayuzlerde var mi
        //Arastirma odevi 2):: Birden fazla girdi alabilen arayuzler varmi
        ...
        //Ornek 1) Function01 adinda bir class olusturunuz ve icinde bir Lambda fonksiyonu tanimlayarak verilen sayinin karesini aliniz.
        //Example 1) Create a class called Function01 and define a Lambda function in it to square the given number
      ...
      /* Function<Integer, Integer> squaring = x -> {
        ...
        int result = squaring.apply(5); //Yukarda Function kullandigimiz icin sadece .apply() ile deger gorebiliyoruz
        System.out.println("Sonuc : " + result);*/


        Function<Integer, Integer> squaring = x -> x * x;
        System.out.println("Sonuc : "+ squaring.apply(6));//Yukardakiyle ayni ama tek satirda yapiyor
