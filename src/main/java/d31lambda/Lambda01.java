...
public class Lambda01 {
    ...
    //example 10: Write a method that prints all unique (non-repetitive) elements with
    ...
    //----------------------------
    //Örnek 11:Bir List<String> içinde karakter sayısı 5'ten fazla olan tüm elemanları
    // büyük harfe çevirip, bu elemanları yeni bir liste olarak döndüren bir metod yazınız.
    //Example 11:Write a method that converts all elements with more than 5 characters in
