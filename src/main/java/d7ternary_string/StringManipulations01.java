...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        char lastChar = s.charAt(11); //charAt index mantigiyla calisir
        char lastChar_2 = s.charAt(s.length() - 1);

        System.out.println(firstChar + " " + lastChar);
        System.out.println(lastChar_2);
        ...
        boolean isStart = s.startsWith("Java i");
