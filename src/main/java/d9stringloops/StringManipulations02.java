...
public class StringManipulations02 {
    public static void main(String[] args) {
        ...
        if (name.indexOf("u") == name.lastIndexOf("u")) {
        ...
        String cardNUm1 ="1234 6789 1234 6789";
        String  left= cardNUm1.substring(0,15).replaceAll("[0-9]","*");
        System.out.print(left);
        String right=cardNUm1.substring(15);
        System.out.println(right);

        String fin=left.concat(right);
