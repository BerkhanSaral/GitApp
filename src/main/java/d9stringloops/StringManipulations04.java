...
public class StringManipulations04 {
    public static void main(String[] args) {
        ...
        ==>Heap, dinamik olarak oluşturulan Object'ler için kullanılır. //non-primitive ler burda
        ...
        String str3 = str1;//adresler esit

        System.out.println(str1==str2);//stack daki adresleri farkl oldugundan dolayu false veriyor icindeki degere bakmiyor
        System.out.println(str1.equals(str2));//heap deki degerlerine bakiyor ikisinde de merhaba ver true doner
        System.out.println(str1==str3);//adreleri ayni

        //string karsilastirmada equals kullan "==" kullanma
