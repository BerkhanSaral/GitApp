...
public class Student {
   ...
   child classlar icinden kullanilabilir. default olanlar baska package'lardan kullanilamazlar
    ...
    Erişim Belirleyicisi	Aynı Sınıf	  Aynı Paket	Alt Sınıf (Farklı Paket)	Tüm Paketler
         public	                      Evet	          Evet	            Evet                	  Evet
         private	                  Evet	          Hayır	            Hayır	                  Hayır
         protected	                  Evet	          Evet	            Evet	                  Hayır
         Varsayılan (default)	      Evet	          Evet	            Hayır	                  Hayır

    */


    public String stdName = "AliCan";
    protected String address = "Antalya";
    ...
    public String toString() {
        return "Student{" +
                ...
                ", address='" + address + '\'' +
                ", email='" + email + '\'' +
               // ", tcKimlik='" + tcKimlik + '\'' + burasi oldugunda private da geliyor bunun sonucunda sizinti oluyor
                '}';
    }
}
