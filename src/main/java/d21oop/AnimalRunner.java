...
public class AnimalRunner {
    public static void main(String[] args) {
        Dog d = new Dog();
        d.bark(); //Dogs bark...
        d.feedWidthMilk(); //Mammals feed their babies with milk
        ...
        Cat c=new Cat();
        c.feedWidthMilk(); //Mammals food thair babies with milk
        ...
        /*c) Ama coklu parent'lardan yararlanamamak iyi olmadi. Ozelliklerini inherit etmek
         ...
         Apartman tarzi yapilanma olusturmustur.( 'Multi Level Inheritance')
