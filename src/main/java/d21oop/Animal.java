...
public class Animal { //public final class Animal == hata final bir class`in child`i olmaz
    ...
    */
    ...
    Child cplass'ının eat metodunun, Parent class'ının eat metodundan daha az erişilebilir olmasından kaynaklanır.
     */
    ...
    public  Animal create() { //HATA == final bir method override edilemez
        return new Animal();
    }
...
//class duzeyinde child olusturulmaz
    //variable duzeyinde degiske degistirilemez
    //method duzeyinde override edilemz
