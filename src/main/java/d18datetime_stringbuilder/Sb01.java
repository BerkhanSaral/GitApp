...
public class Sb01 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(sb2.length());
        System.out.println(sb2.capacity());     //(2 katinin 2 fazlasi )
        ...
        System.out.println(sb3.capacity()); //3, Ali //8, Alis
        ...
        sb4.append("axxxxxxxxxxxxxxxxxxx");
        //sb4.append("axxxxxxxxxxxxxxxxxxxaxxxxxxxxxxxxxxxxxxx"); tek append
        sb4.append("axxxxxxxxxxxxxxxxxxx");
//veri tek seferde gelirse ilk arttirimdan sonra (yane 34) length `in boyuna uyuyor aksine append ile veri ayri ayri gonderilirse ilk basta olan *2+2 islemi uygulaniyor

        System.out.println(sb4.length()); //24 //44, tek append //44, ayri append'ler
        System.out.println(sb4.capacity()); //34 //44, tek append //70, ayri append'ler
    }
}
