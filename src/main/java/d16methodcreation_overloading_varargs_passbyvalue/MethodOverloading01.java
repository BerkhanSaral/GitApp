...
public class MethodOverloading01 {
    public static void main(String[] args) {
        ...
        */
        ...
        //-----------------
        String s="Java";
        //s.substring() bir metodu olusturudguumuz object uzerinden cagiriyorsak o metod non-static`tir
        //Math.min(); bir metodu direkt class adiyla cagiryorsak o metod static`tir


    }
    //ornek 1 : Toplama islemi yapan bir method olusturun ve sonra da overload edin.
    //example 1 : A method that performs an addition operation create and then ove
    ...
    public static void add(int y, double x) {
        System.out.println(x + y);
    }
    public static void add(double y, int x, int c) {
