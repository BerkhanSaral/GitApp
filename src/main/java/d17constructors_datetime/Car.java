...
public class Car {
    ...
    3)Methodlar bir aksiyon yapmak icin olusturulur, Constructorlar ise object olusturmak icindir.(constructorlar objeleri başlatmak ve class'in başlatılmasını sağlamak için kullanılır.)
    ...
    */
    ...
    //13- Iki parametre kabul eden iki tane constructor olusturalim Bitince CarRunner`a gecelim
