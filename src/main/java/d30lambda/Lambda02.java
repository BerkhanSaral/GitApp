...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        getMinGreaterThanSevenEven_2(nums);
    }
    ...
    // 1,1,2,2,3,3,4,4,4,5 --->>>> 1,2,3,4,5
    public static void printCubeOfDistinctOddElements(List<Integer> nums) {
        //(2, 3, 3, 5, 10, 10) //tekrar eden sayilari teke indirir ve tek olan sayilarin kupu
    ...
    public static void printProductOfSquareOfDistinctEvenElements(List<Integer> nums) {
        int toplam = nums.stream().distinct().filter(t -> t % 2 == 0).map(t -> t * t).reduce(1, (t, u) -> t * u);
        System.out.println(toplam);
    }
    ...
    public static void minimum2(List<Integer> nums) {
        ...
        Integer min = nums.
                stream().
                distinct().
                sorted(Comparator.reverseOrder()). //terse dondu 11 10 5 4 3 2
                        reduce((t, u) -> u).get();
        System.out.println(min);
    }
    ...
    public static void getMinGreaterThanSevenEven_2(List<Integer> nums) {
        int min = nums.
                stream().
                distinct().
                filter(t -> t % 2 == 0 && t > 7).
