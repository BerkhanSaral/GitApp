...
public class PredicateInterface {
    public static void main(String[] args) {
        ...
        //Ornek: PredicateInterface adinda bir class acarak, verilen listteki cift sayilari yazdiran bir method olusturalim.
        //Example: Let's create a method that prints even numbers in the given list by opening a class called PredicateInterface.
